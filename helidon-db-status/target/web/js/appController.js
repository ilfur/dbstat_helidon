  ...
  function(ko, Context, moduleUtils, ResponsiveUtils, ResponsiveKnockoutUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ArrayDataProvider, KnockoutTemplateUtils) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'dashboard', detail: { label: 'Start', iconClass: 'oj-ux-ico-bar-chart' } },
        { path: 'customers', detail: { label: 'DBParams', iconClass: 'oj-ux-ico-contact-group' } },
      ...
      this.appName = ko.observable("Dynamic V$parameter view");
      // User Info used in Global Navigation area
      this.userLogin = ko.observable("anonymous@oracle.com");
